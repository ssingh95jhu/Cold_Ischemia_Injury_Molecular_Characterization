...
cis_interface_degs <- read.xlsx("Supplementary_Tables/Limma_cpmCIS_DEGs.xlsx", sheet = "CIS_Interface")
rownames(cis_interface_degs)<-cis_interface_degs$Genes
...
cis_medulla_degs <- read.xlsx("Supplementary_Tables/Limma_cpmCIS_DEGs.xlsx", sheet = "CIS_Medulla")
rownames(cis_medulla_degs)<-cis_medulla_degs$Genes
...
pdf("Figures/Figure4/pdfs/CISvsAKI_DEGs_Cortex_9000x32000.pdf", height=3.5, width=5)
...
pdf("Figures/Figure4/pdfs/CISvsAKI_DEGs_Cortex_500x960.pdf", height=5, width=5)
ggplot(df, aes(x = CIS_CORTEX_DEGS, y = AKI_CORTEX_DEGS)) +
...
colnames(cortex_covary)<-c('Gene', 'CIS_Slope', 'IRI_Slope')
head(cortex_covary)
...
colnames(cortex_disjoint)<-c('Gene', 'CIS_Slope', 'IRI_Slope')
...
pdf("Figures/Figure4/pdfs/CISvsAKI_DEGs_Interface_9000x32000.pdf", height=3.5, width=5)
...
pdf("Figures/Figure4/pdfs/CISvsAKI_DEGs_Interface_500x960.pdf", height=5, width=5)
ggplot(df, aes(x = CIS_INTERFACE_DEGS, y = AKI_INTERFACE_DEGS)) +
  #geom_point(alpha=0.2) +
  geom_point(aes(color=quadrant),alpha=0.8, shape=16) +
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0) +
...
colnames(interface_covary)<-c('Gene', 'CIS_Slope', 'IRI_Slope')
...
colnames(interface_disjoint)<-c('Gene', 'CIS_Slope', 'IRI_Slope')
...
pdf("Figures/Figure4/pdfs/CISvsAKI_DEGs_Medulla_9000x32000.pdf", height=3.5, width=5)
...
pdf("Figures/Figure4/pdfs/CISvsAKI_DEGs_Medulla_500x960.pdf", height=5, width=5)
ggplot(df, aes(x = CIS_MEDULLA_DEGS, y = AKI_MEDULLA_DEGS)) +
  #geom_point(alpha=0.2) +
  geom_point(aes(color=quadrant),alpha=0.8, shape=16) +
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0) +
...
colnames(medulla_covary)<-c('Gene', 'CIS_Slope', 'IRI_Slope')
head(medulla_covary)
...
colnames(medulla_disjoint)<-c('Gene', 'CIS_Slope', 'IRI_Slope')
...
saveWorkbook(wb1, "Supplementary_Tables/Fig4_CISvsAKI_Covary_Disjoint_DEGs_Correlation_R2.xlsx", overwrite = TRUE)
