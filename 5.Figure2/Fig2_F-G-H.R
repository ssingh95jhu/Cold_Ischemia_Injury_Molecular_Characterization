...
pdf("Figures/Figure2/pdfs/CIS_DEGs_Cortex_vs_Interface_9000x9000.pdf", height=3, width=5)
...
pdf("Figures/Figure2/pdfs/CIS_DEGs_Cortex_vs_Interface_400x400.pdf", height=5, width=5)
ggplot(df, aes(x = CIS_CORTEX_DEGS, y = CIS_INTERFACE_DEGS)) +
  # geom_point(alpha=0.2) +
  geom_point(aes(color=quadrant),alpha=0.8, shape=16) +
...
pdf("Figures/Figure2/pdfs/CIS_DEGs_Cortex_vs_Medulla_9000x9000.pdf", height=3, width=5)
...
#Inset plot for the above plot
pdf("Figures/Figure2/pdfs/CIS_DEGs_Cortex_vs_Medulla_400x400.pdf", height=5, width=5)
ggplot(df, aes(x = CIS_CORTEX_DEGS, y = CIS_MEDULLA_DEGS)) +
  # geom_point(alpha=0.2) +
  geom_point(aes(color=quadrant),alpha=0.8, shape=16) +
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0) +
...
pdf("Figures/Figure2/pdfs/CIS_DEGs_Interface_vs_Medulla_9000x9000.pdf", height=3, width=5)
...
pdf("Figures/Figure2/pdfs/CIS_DEGs_Interface_vs_Medulla_400x400.pdf", height=5, width=5)
ggplot(df, aes(x = CIS_INTERFACE_DEGS, y = CIS_MEDULLA_DEGS)) +
  #geom_point(alpha=0.2) +
  geom_point(aes(color=quadrant),alpha=0.8, shape=16) +
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0) +
...
saveWorkbook(wb1,"Supplementary_Tables/Fig2_CIS_Compartmental_Covary_Disjoint_DEGs.xlsx", overwrite=TRUE)
