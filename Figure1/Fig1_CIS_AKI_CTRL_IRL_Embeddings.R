...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#Cortex Spots
color_palette<-c("Cortex"="red", "O.Medulla"="darkgray","I.Medulla"="darkgray","Other"="darkgray")

#CIS
g1<-ggplot(CIS_0h.df, aes(x=X, y=Y, col=Compartment)) + geom_point(size=0.5) + 
  scale_color_manual(values=color_palette) + my_theme
...
pdf("Figures/FigureX/pdfs/CIS_Cortex_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()

#AKI
g1<-ggplot(AKI_sham.df, aes(x=X, y=Y, col=Compartment)) + geom_point(size=0.5) + 
  scale_color_manual(values=color_palette) + my_theme

g2<-ggplot(AKI_4h.df, aes(x=X, y=Y, col=Compartment)) + geom_point(size=0.5) + 
  scale_color_manual(values=color_palette) + my_theme

g3<-ggplot(AKI_12h.df, aes(x=X, y=Y, col=Compartment)) + geom_point(size=0.5) + 
  scale_color_manual(values=color_palette) + my_theme

g4<-ggplot(AKI_48h.df, aes(x=X, y=Y, col=Compartment)) + geom_point(size=0.5) + 
  scale_color_manual(values=color_palette) + my_theme

pdf("Figures/FigureX/pdfs/AKI_Cortex_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/CTRL_Cortex_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/AKI24_Cortex_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()


#Interface Spots
color_palette<-c("Cortex"="darkgray", "O.Medulla"="blue","I.Medulla"="darkgray","Other"="darkgray")
...
pdf("Figures/FigureX/pdfs/CIS_OMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/AKI_OMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/CTRL_OMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/AKI24_OMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()


#Medulla Spots
color_palette<-c("Cortex"="darkgray", "O.Medulla"="darkgray","I.Medulla"="green","Other"="darkgray")
...
pdf("Figures/FigureX/pdfs/CIS_IMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/AKI_IMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/CTRL_IMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
...
pdf("Figures/FigureX/pdfs/AKI24_IMedulla_Only_Annotations_ggplot.pdf", height=3, width=12)
grid.arrange(g1,g2, g3, g4, ncol=4)
dev.off()
