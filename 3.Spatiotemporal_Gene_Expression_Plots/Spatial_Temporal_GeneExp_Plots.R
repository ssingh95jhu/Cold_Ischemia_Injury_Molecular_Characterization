...
##################### PLOTTINGCIS DATASET ######################################
g<-'Tfeb' #Insert any gene of interest, for e.g., Tfeb
...
g<-'Lcn2'# Insert any gene of interest here, for e.g., Lcn2
...
g <-'Ppargc1a'#Insert gene of interest here, for e.g., Ppargc1a
...
#Save the image
library(gridExtra)
pdf("Figures/FigureX/pdfs/CTRL_Ppargc1a_AllTimepoints.pdf", height=3, width=15)
grid.arrange(comb_plot,ctrl_gline, ncol=2, widths=c(16, 5), top=g)
dev.off()
